...
namespace ThuVienDienTu.Areas.Admin.Controllers
{
    ...
    public class ReportsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,CreateDate,Total")] Report report)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CreateDate,Total")] Report report)
        {
            if (id != report.Id)
            {
                return NotFound();
